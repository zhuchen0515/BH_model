...
"""
Calculate the stellar mass and halo mass relation (SMHM)
And the halo growth function
...
from cosmos import InitCosmos

class SMHM_Sandy(object):
     def __init__(self):
          pass
...
##combine together
class SMHM_Lin(SMHM_Sandy,MHGrowth_Sandy):
     def __init__(self):
          SMHM_Sandy.__init__(self)
          MHGrowth_Sandy.__init__(self)

     def __del__(self):
          pass

class SMHM_bend(SMHM_Moster,MHGrowth_Sandy):
     def __init__(self):
          SMHM_Moster.__init__(self)
          MHGrowth_Sandy.__init__(self)
...
class MHGrowth_Fakhouri(InitCosmos):
     def __init__(self):
          InitCosmos.__init__(self)
...
##Ref. Aldo et al. 2016
class MHGrowth_Aldo(InitCosmos):
     def __init__(self):
          InitCosmos.__init__(self)
